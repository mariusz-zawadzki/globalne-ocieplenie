...
function dataForCityAndYear(city: string, year: string): Promise<ReadResult> {
    ...
    return docs.then(function (value: DocumentSnapshot) {
        ...
        if(temperatures){
            return {data: DAYS.map((day)=>{return temperatures.get(day)}), year: year}
        }
    ...
    render(): React.ReactElement<any, string | React.JSXElementConstructor<any>> | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined {
        return <div>
            <div>
                ...
                <Cities cities={["1984","1985","1988","2014","2018","2019"]} updateCity={(years)=> this.updateChart(this.state.city, years)} multiselect={true}/>
            </div>
            <ReactEcharts ref={(e) => {
